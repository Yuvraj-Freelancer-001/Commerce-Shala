...
const boards = ['All', 'CBSE', 'ISC', 'ICSE', 'UP Board', 'CA Foundation', 'CS Foundation'] as const;
...
const courses = [
  ...
  },
  {
    ...
    icon: '📗',
    number: '06',
    tagline: 'ICSE Excellence. 9th & 10th.',
    desc: 'Complete ICSE commerce foundation for Class 9th & 10th students. Strong base building for board exams and future studies.',
    features: ['Class 9th & 10th focus', 'ICSE exam pattern', 'Foundation building', 'Board exam preparation'],
    waMsg: 'Hi, I want to enrol for ICSE subjects at Commerce Shala.',
  },
  {
    id: 7,
    title: 'All Subjects',
  ...
  },
  {
    ...
    icon: '🏦',
    number: '08',
    tagline: 'Your CA Journey Starts Here.',
    desc: 'Comprehensive CA Foundation preparation covering Accounts, Law, Maths & Economics with exam-focused strategy and mock tests.',
    features: ['All 4 subjects covered', 'Mock test series', 'Concept to application', 'Expert mentorship'],
    waMsg: 'Hi, I want to enrol for CA Foundation at Commerce Shala.',
  },
  {
    id: 9,
    title: 'CS Foundation',
    ...
    icon: '⚖️',
    number: '09',
    tagline: 'Company Secretary. First Step.',
    desc: 'CS Foundation course covering Business Environment, Business Management, Business Economics and Financial Accounting.',
    features: ['Complete syllabus coverage', 'Legal concepts simplified', 'Regular assessments', 'Career guidance'],
    waMsg: 'Hi, I want to enrol for CS Foundation at Commerce Shala.',
  },
];
...
const boardColors: Record<string, string> = {
  ...
  ICSE: '#D4AF37',
  'UP Board': '#D4AF37',
  'CA Foundation': '#D4AF37',
  'CS Foundation': '#D4AF37',
};
